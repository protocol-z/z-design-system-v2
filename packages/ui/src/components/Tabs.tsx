  ...
  return (
    <span
      style={{
        ...
        height: 18,
        padding: "0 6px",
        background: active ? "rgba(255,255,255,0.18)" : "var(--zds-paper)",
        border: active ? "none" : "1px solid var(--zds-line)",
        borderRadius: "var(--zds-radius-pill)",
        color: active ? "#fff" : "var(--zds-text-tertiary)",
        fontSize: 11,
        ...
        return (
          <button
            ...
            style={{
              ...
              borderRadius: "var(--zds-radius-pill)",
              border: "none",
              background: active ? "var(--zds-ink-950)" : "transparent",
              color: active ? "#fff" : tab.disabled ? "var(--zds-text-tertiary)" : "var(--zds-text-secondary)",
              font: "inherit",
              fontSize: 13,
              fontWeight: 500,
